...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    if (translateX > 250 && translateY > 350) {
        move = true;
    }

    if (translateX < 150 && translateY < 250) {
        move = false;
    }
    ...
    //al doilea patrat translate + rotate
    ...
    if (scaleX >= 1.5) scale = false;
    if (scaleX < 0) scale = true;
